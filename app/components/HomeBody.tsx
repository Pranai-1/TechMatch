...
export default function HomeBody(){
    return(
      ...
      <p className='text-4xl font-bold text-blue-600 '>Connect with like-minded coders at Coders Connect!</p>
      <p className='text-gray-600'>Our platform helps you discover and connect with incredible developers from around the world.</p>
      <Link href="/login"
      className='bg-black text-white flex font-bold p-2 rounded-lg mt-3'>Sign in with
    ...
    <div className='mt-10 flex flex-wrap flex-col p-2 justify-start'>
      ...
      <p className='text-gray-500 pl-2 font-medium'>Here at Coders Connect You'll be matched with fellow coders who share your 
