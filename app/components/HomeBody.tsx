    ...
    <>
      <div className="mt-10 p-2 flex flex-wrap flex-col justify-center items-center gap-3">
        <p className="text-4xl font-bold text-blue-600 ">
          Connect with like-minded coders at TechMatch
        </p>
        <p className="text-gray-600">
          Our platform helps you discover and connect with incredible developers from around the world.
        </p>
        {data?.user?(
            <Link href="/match" className="bg-black text-white flex font-bold p-2 rounded-lg mt-3">Find a Match
            </Link>
        ):(
            <button className="bg-black text-white flex font-bold p-2 rounded-lg mt-3" onClick={()=>signIn()}>
            Sign in with
      ...
      <div className="mt-10 flex flex-wrap flex-col p-2 justify-start">
        ...
        <p className="text-gray-500 pl-2 font-medium">
          Here at TechMatch You will be matched with fellow coders who share your passion and expertise. 
